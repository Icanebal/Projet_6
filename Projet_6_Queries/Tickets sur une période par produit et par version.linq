...
string produit = "Planificateur d’Anxiété Sociale";
string version = "2.0";
DateTime dateMin = new DateTime(2024, 01, 01);
DateTime dateMax = new DateTime(2024, 03, 01);

Tickets
    .ApplyFilters(statut, produit, version, dateMin, dateMax, null)
    .ToTicketDto()
    .Dump();
