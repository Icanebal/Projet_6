    ...
    public static class SeedData
    {
        public static void Initialize(AppDbContext context)
        {
            ...
            context.OperatingSystems.AddRange(
                new OperatingSystem { OsId = 1, OsName = "Android" },
                new OperatingSystem { OsId = 2, OsName = "Linux" },
                new OperatingSystem { OsId = 3, OsName = "MacOS" },
                new OperatingSystem { OsId = 4, OsName = "Windows" },
                new OperatingSystem { OsId = 5, OsName = "Windows Mobile" },
                new OperatingSystem { OsId = 6, OsName = "iOS" }
            );
            ...
            context.ProductVersionOperatingSystems.AddRange(
                // Trader en Herbe - 1.0
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 1, ProductVersionId = 1, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 2, ProductVersionId = 1, OsId = 2 },

                // Trader en Herbe - 1.1
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 3, ProductVersionId = 2, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 4, ProductVersionId = 2, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 5, ProductVersionId = 2, OsId = 3 },

                // Trader en Herbe - 1.2
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 6, ProductVersionId = 3, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 7, ProductVersionId = 3, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 8, ProductVersionId = 3, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 9, ProductVersionId = 3, OsId = 4 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 10, ProductVersionId = 3, OsId = 5 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 11, ProductVersionId = 3, OsId = 6 },

                // Trader en Herbe - 1.3
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 12, ProductVersionId = 4, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 13, ProductVersionId = 4, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 14, ProductVersionId = 4, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 15, ProductVersionId = 4, OsId = 4 },

                // Maître des Investissements - 1.0
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 16, ProductVersionId = 5, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 17, ProductVersionId = 5, OsId = 3 },

                // Maître des Investissements - 2.0
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 18, ProductVersionId = 6, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 19, ProductVersionId = 6, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 20, ProductVersionId = 6, OsId = 3 },

                // Maître des Investissements - 2.1
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 21, ProductVersionId = 7, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 22, ProductVersionId = 7, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 23, ProductVersionId = 7, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 24, ProductVersionId = 7, OsId = 5 },

                // Planificateur d’Entraînement - 1.0
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 25, ProductVersionId = 8, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 26, ProductVersionId = 8, OsId = 3 },

                // Planificateur d’Entraînement - 1.1
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 27, ProductVersionId = 9, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 28, ProductVersionId = 9, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 29, ProductVersionId = 9, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 30, ProductVersionId = 9, OsId = 4 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 31, ProductVersionId = 9, OsId = 5 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 32, ProductVersionId = 9, OsId = 6 },

                // Planificateur d’Entraînement - 2.0
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 33, ProductVersionId = 10, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 34, ProductVersionId = 10, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 35, ProductVersionId = 10, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 36, ProductVersionId = 10, OsId = 4 },

                // Planificateur d’Anxiété Sociale - 1.0
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 37, ProductVersionId = 11, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 38, ProductVersionId = 11, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 39, ProductVersionId = 11, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 40, ProductVersionId = 11, OsId = 4 },

                // Planificateur d’Anxiété Sociale - 1.1
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 41, ProductVersionId = 12, OsId = 1 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 42, ProductVersionId = 12, OsId = 2 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 43, ProductVersionId = 12, OsId = 3 },
                new ProductVersionOperatingSystem { ProductVersionOperatingSystemId = 44, ProductVersionId = 12, OsId = 4 }
            );
            ...
            context.Tickets.AddRange(
                ...
                new Ticket { TicketId = 21, ProductVersionOperatingSystemId = 21, TicketStatusId = 1, CreationDate = new DateTime(2024, 3, 29), ResolutionDate = new DateTime(2024, 4, 12), Issue = "Certaines actions s’affichent en double après l’opération d’un achat.", Resolution = "" },
